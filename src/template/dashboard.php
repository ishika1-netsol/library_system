        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="http://localhost:8000/UserTable.php"> User Table
                </a></li>
              <li class="nav-item"> <a class="nav-link" href="http://localhost:8000/BookTable.php"> Book Table</a>
              </li>
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item" href="http://localhost/library%20system/logout.php">
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-dark rounded-circle">
